...
const data = {
  ...
  description:
    "Griptok อะคริลิคใสด้านหน้า 1.5 มม. พิมพ์ลาย UV ประกบตัวอะคริลิคกระจก 1.5 มม. มีกระจกส่องหน้าในตัว ขนาด 5-10cm สั่งทำตามแบบ · เพิ่มช่องกรอบใส่ภาพได้ · คละลาย คละขนาดได้",
  priceRates: [
    {
      id: "r1",
      label: "ราคาตามขนาด",
  ...
  options: [
    ...
    },
    {
      ...
      note: "เพิ่มชั้นอะคริลิคใสด้านหน้าอีก **1 มม.** เป็นช่องเสียบภาพ ถอดเปลี่ยนรูปเองได้ — ดูตัวอย่างคลิปทรงแสตมป์ในแกลเลอรี",
      choices: [
        { name: "ไม่เพิ่ม" },
  ...
  terms:
    "1-10 ชิ้น คละลายได้ · ตั้งแต่ 11 ชิ้นขึ้นไป คละลาย คละขนาด ขั้นต่ำดีเทลละ 5 ชิ้น · ฐานสีดำ/สีขาว ฟรี · ฐานใส +5 บาท · ช่องกรอบใส่ภาพ +15 บาท",
  seo: {
