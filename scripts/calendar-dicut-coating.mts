...
const [coatFront, filmFront] = coatingPair(
  srcCoatFront,
  srcFilmFront,
  "เคลือบฟิล์มด้านหน้ากระดาษทุกแผ่นในเล่ม — เงา/ด้าน **10 บาท ต่อแผ่น A3** · " +
    "เคลือบพิเศษ (เนื้อทราย / กลิสเตอร์ / โฮโลแกรม) **40 บาท ต่อแผ่น A3** · " +
    A3_NOTE
);
const [coatBack, filmBack] = coatingPair(
  srcCoatBack,
  srcFilmBack,
  "เคลือบฟิล์มด้านหลังกระดาษ (อีกหน้าของแผ่นเดียวกัน) — คิดราคาเท่าด้านหน้า **เงา/ด้าน 10 บาท · พิเศษ 40 บาท ต่อแผ่น A3** · " +
    "เลือกคนละแบบกับด้านหน้าได้ · ไม่ต้องการเคลือบด้านหลัง เลือก “ไม่เคลือบด้านหลัง” ไว้ (ไม่มีค่าใช้จ่าย)"
);
...
foil.note =
  "ปั๊มฟอยล์เมทัลลิกทับลายด้านหน้า — 1 เลเยอร์ **40 บาท** · 2 เลเยอร์ **60 บาท ต่อแผ่น A3** · " +
  "งานเคลือบฟอยล์ทุกงานต้องมีการ**เคลือบด้าน**ร่วมด้วย (รวมอยู่ในขั้นตอนงานฟอยล์แล้ว ไม่คิดเพิ่ม) — " +
  "เลือกฟอยล์แล้วกลุ่มเคลือบด้านหน้าจะล็อกเป็น “เคลือบด้าน (มากับงานฟอยล์)” ให้เอง · " +
  A3_NOTE;
foilColor.note = "สีฟอยล์ที่ใช้ปั๊ม — สีโฮโลแกรมบวกเพิ่ม 10 บาทต่อแผ่น A3";
