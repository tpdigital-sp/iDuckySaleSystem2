 ...
 *   ขนาดชิ้นที่ 1 / ขนาดชิ้นที่ 2  → การ์ดเทียบขนาดจากรูปงานจริง (2 กลุ่มใช้ไฟล์ชุดเดียวกัน
...
const MAP = {
  "ขนาดชิ้นที่ 1": { "2cm": "size-2-v1", "3cm": "size-3-v1", "4cm": "size-4-v1", "5cm": "size-5-v1", "6cm": "size-6-v1" },
  "ขนาดชิ้นที่ 2": { "2cm": "size-2-v1", "3cm": "size-3-v1", "4cm": "size-4-v1", "5cm": "size-5-v1", "6cm": "size-6-v1" },
  ชนิดอะคริลิค: {
