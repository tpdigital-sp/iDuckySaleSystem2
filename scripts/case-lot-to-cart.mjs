 ...
 *
 * ของใหม่: เหลือปุ่มเดียว "🛒 เพิ่มลงตะกร้า" — กดแล้วรุ่นนั้นลงตะกร้าเป็นบรรทัดของตัวเอง แล้วฟอร์มรับรุ่นถัดไปต่อ
 * (ปุ่ม ➕ ถูกเอาออกจากสินค้ากลุ่มนี้ — สองปุ่มทำเรื่องเดียวกันแค่ชวนงง)
...
const TEXT_SWAPS = [
  ...
  /**
   * ④ รอบสอง (ผู้ใช้สั่ง 31 ส.ค. 69) — เอาปุ่ม ➕ ออก เหลือปุ่มเดียวคือ "🛒 เพิ่มลงตะกร้า"
   *    ข้อความชุด ①/② ข้างบนจึงต้องเลิกอ้างปุ่ม ➕ ที่ไม่มีอยู่แล้ว
   */
  [
    "แล้วกดปุ่ม “➕ ใส่ตะกร้า แล้วตั้งรุ่นถัดไป” — รุ่นนั้นลงตะกร้าทันที แล้วตั้งรุ่นถัดไปต่อได้เลย (จำนวนแก้ทีหลังที่ตะกร้าได้)",
    "แล้วกดปุ่ม “🛒 เพิ่มลงตะกร้า” — รุ่นนั้นลงตะกร้าทันที แล้วตั้งรุ่นถัดไปต่อได้เลย (จำนวนแก้ทีหลังที่ตะกร้าได้)",
  ],
  ["กด “➕ ใส่ตะกร้า แล้วตั้งรุ่นถัดไป”", "กด “🛒 เพิ่มลงตะกร้า”"],
  [
    "กด ➕ แล้วช่องแนบลายจะว่างให้แนบของรุ่นถัดไป",
    "ใส่ตะกร้าแล้วช่องแนบลายจะว่างให้แนบของรุ่นถัดไป",
  ],
  [
    "รุ่นที่ 1 ลงตะกร้าทันที แล้วเปิดฟอร์มรุ่นถัดไปให้ — ทำซ้ำจนครบ (แต่ละรุ่นแนบลายของตัวเองได้)",
    "รุ่นที่ 1 ลงตะกร้าทันที แล้วฟอร์มพร้อมรับรุ่นถัดไปต่อเลย — ทำซ้ำจนครบ (แต่ละรุ่นแนบลายของตัวเองได้)",
  ],
];
