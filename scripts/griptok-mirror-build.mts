...
const product: Product = {
  ...
  options: [
    ...
    {
      label: "ฐาน Griptok",
      // 📝 ข้อความกำกับใต้ชื่อกลุ่ม (ผู้ใช้สั่ง 25 ส.ค. 69 — อยากให้มีคำอธิบายตรงจุดนี้ด้วย)
      note:
        "ฐานตัวจับด้านหลังชิ้นงาน กดยืด-พับเก็บได้ (ฐานกลม ~3.5 ซม.) ใช้แปะหลังมือถือหรือเคส — " +
        "**ฐานสีดำและสีขาว ฟรี** · เฉพาะฐานใส บวกเพิ่ม 5 บาท",
      display: "cards",
      choices: [
