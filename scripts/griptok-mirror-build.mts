...
const TABS: Product["tabs"] = [
  {
    ...
    text: [
      "• GRIPTOK MIRROR (กระจก) — งานอะคริลิคประกบ 2 ชิ้น ด้านบนเป็นอะคริลิคกระจกเงาสะท้อน + ด้านล่างเป็นอะคริลิคขาว · พิมพ์ลายระบบ UV Printing",
...
const product: Product = {
  ...
  description:
    ...
    "ด้านบนเป็นอะคริลิคกระจกเงาสะท้อนแบบกระจกจริง ด้านล่างเป็นอะคริลิคขาว ไดคัทตามลายที่ส่งมา " +
    "เลือกขนาดได้ 4-6 ซม. ฐานสีขาว/ดำ/ใส ไม่มีขั้นต่ำในการสั่งผลิต ยิ่งสั่งเยอะยิ่งถูก",
  highlights: [
    "เนื้ออะคริลิคกระจก เงาสะท้อนแบบกระจกจริง",
    "งานประกบ 2 ชิ้น — บนกระจก + ล่างอะคริลิคขาว",
  ...
  terms: [
    "งานอะคริลิคประกบ 2 ชิ้น — ด้านบนเป็นอะคริลิคกระจก ด้านล่างเป็นอะคริลิคขาว",
