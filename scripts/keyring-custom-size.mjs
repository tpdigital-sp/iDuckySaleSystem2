 ...
 *
 *  1) ลูกค้าสั่งขนาดทศนิยมได้ (3.5 × 2.8 ซม.) — ราคาคิดตามด้านที่ยาวที่สุด ปัดขึ้นเต็ม ซม.
 *     แล้วไปเกาะแถวขนาดในตารางเรทเดิม (3.5 → แถว 4cm)
...
// 2) สเปกคิดราคา (ปัดด้านยาวสุดขึ้นเต็ม ซม. → แถวในตาราง · เกิน 10 ซม. = ตีราคา)
...
const pair = [
  ...
  field(
    H_LABEL,
    `ราคาคิดจากด้านที่ยาวที่สุด ปัดขึ้นเต็มเซนติเมตร (3.5 ซม. คิดเท่าแถว 4cm) · ด้านยาวสุดเกิน ${ASK_OVER} ${UNIT} แอดมินตีราคาให้`
  ),
];
for (const f of pair) {
