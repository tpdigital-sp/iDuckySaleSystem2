 ...
 *     เงิน DSC09305 (25°) = การ์ดแมว 福 · โฮโลแกรม DSC09293 ใบขวา (5°) = การ์ดซานต้า
 *     ⚠️ DSC09293 ใบเดียวให้ 2 สี: ใบซ้าย = โรสโกล · ใบขวา = โฮโลแกรม
 *     ⚠️ มีนิ้วจับการ์ดในภาพ ทั้งสองใบต้องครอปให้นิ้วหลุดนอกกรอบ (ผู้ใช้สั่ง "เอานิ้วออก")
 *        ใบขวา (โฮโล): ครอปฝั่งขวาของเสื้อคลุม · ใบซ้าย (โรสโกล): ครอปฝั่งซ้าย เลี่ยงมุมขวาล่าง
 *        (ครอปเหนือนิ้วไม่ได้ เพราะเนื้อฟอยล์โฮโลอยู่ที่เสื้อคลุมด้านล่าง จะเหลือแต่พื้นน้ำเงิน)
 *     ⚠️ การ์ดแมวที่ 福 เป็นชมพู-ม่วงเหลือบ = โฮโลแกรม (ไม่ใช่โรสโกล — เคยแมปสลับมาแล้ว)
 *     ใบโฮโลแกรมผู้ใช้ไล่เปลี่ยนมา 3 รอบ จบที่ DSC09346 (ระยะใกล้ เห็นเหลือบรุ้งบนตัว 福 ชัดสุด · lap 157)
 *     ทอง DSC09296 (-16°) · โรสโกล DSC09293 (38°) = การ์ดซานต้าพื้นน้ำเงิน ครอปเต็มกรอบ
 *     (เคยลองสลับโรสโกลไปใช้ 福 ใบกลางของ DSC09346 แล้วผู้ใช้ให้กลับมาใช้การ์ดซานต้าเหมือนเดิม)
 *     ⚠️ ผู้ใช้ไม่ชอบภาพที่มีพื้นหลังว่าง — ครอปให้ตัวการ์ดเต็มกรอบเสมอ
