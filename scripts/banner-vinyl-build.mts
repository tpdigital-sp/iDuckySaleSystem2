...
const OPTIONS: ProductOption[] = [
  ...
  },
  {
    ...
    input: {
      ...
      hint: "ระบบคำนวณจำนวน ตร.ม. ให้อัตโนมัติจากขนาดที่กรอก — เศษพื้นที่ปัดขึ้นเต็ม ตร.ม. (1 ตร.ม. = 100×100 ซม. คิดขั้นต่ำ 1 ตร.ม.)",
    },
  },
];
...
const product: Product = {
  ...
  pricing,
  /**
   * 📐 จำนวน ตร.ม. ล็อกตามขนาดที่กรอก ปัดขึ้นเต็ม ตร.ม. (ผู้ใช้เคาะ 25 ส.ค. 69 —
   * กันเคสกรอก 140×200 ซม. = 2.8 ตร.ม. แต่จำนวนค้างที่ 1 แล้วจ่ายแค่ 250)
   */
  qtyFromArea: { widthLabel: W_LABEL, heightLabel: H_LABEL, areaPerUnit: 10000 },
  terms: [
    "*ราคาต่อ 1 ตร.ม. (1 ตารางเมตร = 100×100 ซม.) — คิดราคาขั้นต่ำ 1 ตร.ม. เศษพื้นที่ปัดขึ้นเต็ม ตร.ม. (เช่น 140×200 ซม. = 2.8 → คิด 3 ตร.ม.)",
    ...
    faqs: [
      {
        ...
        a: `เริ่มต้น ${prices[0]} บาท/ตร.ม. (1-10 ตร.ม.) ยิ่งสั่งเยอะยิ่งถูกลง จนถึง 50 ตร.ม. ขึ้นไปเหลือ ${prices[prices.length - 1]} บาท/ตร.ม. — คิดราคาขั้นต่ำ 1 ตร.ม. (100×100 ซม.) เศษพื้นที่ปัดขึ้นเต็ม ตร.ม.`,
      },
      {
