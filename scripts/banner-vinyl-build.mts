 ...
 *   4 มุม / รอบขอบ (ระบุระยะในหมายเหตุ) / ไม่เจาะ — ภาพงานจริงจากหน้า /banner (wixstatic)
...
const OPTIONS: ProductOption[] = [
  {
    ...
    choices: [
      ...
      {
        name: "เจาะตาไก่รอบขอบ",
        badge: "ฟรี",
        imageSrc: art.eyeletHook,
        desc: "เพิ่มตาไก่ตามแนวขอบผืน ยึดแน่นทั้งผืน ลมตีไม่บิด — ระบุระยะที่ต้องการในหมายเหตุถึงร้าน (เช่น ทุก 50 ซม. / ทุก 1 เมตร)",
      },
      {
        name: "ไม่เจาะตาไก่",
  ...
  },
  {
    ...
    input: {
      ...
      hint: "ราคาคิดตามจำนวน ตร.ม. ที่สั่ง (1 ตร.ม. = 100×100 ซม. คิดขั้นต่ำ 1 ตร.ม.) — เช่น 100×200 ซม. = 2 ตร.ม. ให้เลือกจำนวน 2",
    },
  },
];
...
const product: Product = {
  ...
  highlights: [
    ...
    "เจาะตาไก่ให้ฟรี!! เลือกได้ 4 มุม / รอบขอบ / ไม่เจาะ",
  ],
  options: OPTIONS,
  images: gallery,
  pricing,
  terms: [
    "*ราคาต่อ 1 ตร.ม. (1 ตารางเมตร = 100×100 ซม.) — คิดราคาขั้นต่ำ 1 ตร.ม.",
  ...
  tabs: [
    {
      ...
      text: [
        ...
        "• เจาะตาไก่ให้ฟรี!! เลือกได้ทั้งแบบ 4 มุม / รอบขอบ / ไม่เจาะ",
        "• จำนวน 1-10 อัน คละลายได้ · 11 อันขึ้นไป คละลาย สั่งลายละ 5 อันขึ้นไป",
      ].join("\n"),
    },
    ...
    faqs: [
      {
        ...
        a: `เริ่มต้น ${prices[0]} บาท/ตร.ม. (1-10 ตร.ม.) ยิ่งสั่งเยอะยิ่งถูกลง จนถึง 50 ตร.ม. ขึ้นไปเหลือ ${prices[prices.length - 1]} บาท/ตร.ม. — คิดราคาขั้นต่ำ 1 ตร.ม. (100×100 ซม.)`,
      },
      {
        q: "สั่งป้ายไวนิลขนาดใหญ่สุดได้เท่าไหร่?",
        a: "หน้ากว้างได้สูงสุด 148 ซม. ส่วนด้านยาวสั่งได้ตามต้องการ — ระบุขนาด กว้าง×สูง ได้เลยในหน้าสินค้า ระบบคิดราคาตามจำนวนตารางเมตร",
      },
      {
        q: "เจาะตาไก่คิดเงินเพิ่มไหม?",
        a: "เจาะตาไก่ให้ฟรีทุกแบบ เลือกได้ทั้งเจาะ 4 มุม เจาะรอบขอบ (ระบุระยะที่ต้องการได้) หรือไม่เจาะสำหรับงานใส่รางหนีบ/กรอบ",
      },
      {
