...
const cases: [string, Record<string,string>, number][] = [
  ...
  ["A5 + ตะขอ F เงิน 1 ชิ้น · 8 ชุด (สี F เงิน 8)", { "ขนาด": "A5 (14.8×21 ซม.)", "รับตะขอไหม": "รับตะขอ", "ตะขอ": HOOK, "สีตะขอ · โลหะ (F/J/K/L/M/N/O)": "สีเงิน" }, 8],
  ["A5 + ตะขอ F เงิน 3 ชิ้น · 8 ชุด (สี 8×3)", { "ขนาด": "A5 (14.8×21 ซม.)", "รับตะขอไหม": "รับตะขอ", "ตะขอ": `${HOOK} ×3`, "สีตะขอ · โลหะ (F/J/K/L/M/N/O)": "สีเงิน" }, 8],
  ["A5 + ตะขอ F เงิน 3 ชิ้น · 30 ชุด (สีคูณ 3)", { "ขนาด": "A5 (14.8×21 ซม.)", "รับตะขอไหม": "รับตะขอ", "ตะขอ": `${HOOK} ×3`, "สีตะขอ · โลหะ (F/J/K/L/M/N/O)": "สีเงิน" }, 30],
  ["A5 + ตะขอ F เงิน 1 ชิ้น · 30 ชุด", { "ขนาด": "A5 (14.8×21 ซม.)", "รับตะขอไหม": "รับตะขอ", "ตะขอ": HOOK, "สีตะขอ · โลหะ (F/J/K/L/M/N/O)": "สีเงิน" }, 30],
  ["A5 + ห่วง Z1 ×3 (2×3) · 8 ชุด", { "ขนาด": "A5 (14.8×21 ซม.)", "รับตะขอไหม": "รับตะขอ", "ตะขอ": "Z1 ห่วงกลม (สีเงิน) ×3" }, 8],
  ["A5 + Z1×2 + F×3 เงิน · 8 ชุด (2×2 + 8×3)", { "ขนาด": "A5 (14.8×21 ซม.)", "รับตะขอไหม": "รับตะขอ", "ตะขอ": `Z1 ห่วงกลม (สีเงิน) ×2${MULTI_SEP}${HOOK} ×3`, "สีตะขอ · โลหะ (F/J/K/L/M/N/O)": "สีเงิน" }, 8],
  ["A5 + เพิ่มชิ้นงาน 2 ชิ้น (แอดมินตีราคา)", { "ขนาด": "A5 (14.8×21 ซม.)", "เพิ่มจำนวนชิ้นงาน (เกิน 5 ชิ้นต่อกรอบ)": "เพิ่มชิ้นงานจาก 5 ชิ้น ×2" }, 8],
  ["8×8 + ตะขอ G เขียว ×2 · 30 ชุด (สี G8 10×2)", { "ขนาด": "8×8 ซม.", "รับตะขอไหม": "รับตะขอ", "ตะขอ": "G ตะขอสปริงพลาสติก (หลายสี) ×2", "สีตะขอ G": "G8 สีเขียวอ่อน" }, 30],
];
