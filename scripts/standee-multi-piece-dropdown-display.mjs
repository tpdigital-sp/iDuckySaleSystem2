// สแตนดี้ หลายชิ้นใน 1 ฐาน (new-mt1dwpc1-6773): ทุกกลุ่มตัวเลือกเป็น dropdown
...
// รัน: node scripts/standee-multi-piece-dropdown-display.mjs        (dry-run)
//      node scripts/standee-multi-piece-dropdown-display.mjs --write
