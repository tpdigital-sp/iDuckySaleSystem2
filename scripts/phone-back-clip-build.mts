 ...
 *   • เฉพาะเรท Acrylic (showWhen เรทราคา): ขนาดอะคริลิค 5cm ฟรี → +10/cm · ชนิดอะคริลิค = ใส (หนา 2mm) ชนิดเดียว
...
const OPTIONS: ProductOption[] = [
  ...
  {
    // มีชนิดเดียว (ผู้ใช้สั่ง 25 ส.ค. 69: "มีแค่ อะคริลิคใส เท่านั้น") — คงกลุ่มไว้ให้ลูกค้าเห็นสเปคชัด ๆ
    label: "ชนิดอะคริลิค",
    display: "pills",
    showWhen: { label: RATE_LABEL, choices: [AC_RATE] },
    choices: [{ name: "อะคริลิคใส (หนา 2mm)" }],
  },
];
