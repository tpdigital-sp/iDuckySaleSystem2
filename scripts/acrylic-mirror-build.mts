 ...
 *
 * ⛔ รันทับเมื่อไหร่ ต้องรัน `node scripts/acrylic-mirror-fees.mjs --write` ตามทุกครั้ง
 *    สคริปต์นี้ยังเขียนกติกาชุดแรก (2 ก.ย. 69 ผู้ใช้สั่งเปลี่ยน 3 ข้อ):
 *      • ตะขอ/สีตะขอ ฟรีช่วงปลีก 1-10 ชิ้น (extraFromQty 11 — ตรรกะเดียวกับพวงกุญแจอะคริลิค)
 *      • ค่าฐานคิดแบบ standee-rotating (ฐาน 2-5cm รวมในราคา · เกินนั้น ปลีก ซม.ละ 15 · ส่ง ซม.ละ 10)
 *        ไม่ใช่ชุดฐานของ standy ที่สคริปต์นี้โคลนมา
 *      • ค่าคละเกินโควตา = ลายละ 5 บาท (extraDesignFee) ไม่ใช่ชิ้นละ 5 (underMinPieceFee) · ไม่มี tierByDesign
 *
