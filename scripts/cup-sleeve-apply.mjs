...
d.highlights = [
  ...
  `เคลือบเงา / ด้าน +฿${COAT_FEE} ต่อด้าน · เคลือบพิเศษ (เฉพาะด้านหน้า) +฿${SPECIAL_FEE}`,
];
...
d.terms = [
  ...
  `เคลือบเงา / เคลือบด้าน บวกเพิ่ม ${COAT_FEE} บาทต่อด้าน · เคลือบพิเศษ (กลิตเตอร์ · ทราย · โฮโลแกรม) ทำได้เฉพาะด้านหน้า บวกเพิ่ม ${SPECIAL_FEE} บาท`,
...
d.tabs = [
  {
    ...
    text: [
      ...
      `• เคลือบพิเศษ (กลิตเตอร์ · ทราย · โฮโลแกรม) ทำได้เฉพาะด้านหน้า บวกเพิ่ม ${SPECIAL_FEE} บาท`,
    ].join("\n"),
  ...
  },
  {
    ...
    text: [
      ...
      "• ด้านหลังเคลือบได้แค่เงา/ด้าน — เคลือบพิเศษ (กลิตเตอร์ · ทราย · โฮโลแกรม) ทำได้เฉพาะด้านหน้า",
...
d.seo = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: `เคลือบเงาหรือเคลือบด้าน บวกเพิ่ม ${COAT_FEE} บาทต่อด้าน · เคลือบพิเศษ (กลิตเตอร์ ทราย โฮโลแกรม) ทำได้เฉพาะด้านหน้า บวกเพิ่ม ${SPECIAL_FEE} บาท`,
    },
    {
