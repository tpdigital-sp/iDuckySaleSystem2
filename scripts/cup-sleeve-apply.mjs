...
const COAT_HOLO_LABEL = "เคลือบผิว (กระดาษโฮโลแกรม · เงิน-ทอง)";
const COAT_IN_HOLO_LABEL = "เคลือบด้านใน (กระดาษโฮโลแกรม · เงิน-ทอง)";
...
const COAT_IN_GLOSS = "เคลือบเงา (ด้านใน)";
const COAT_IN_MATTE = "เคลือบด้าน (ด้านใน)";
