 ...
 *
 * ⚠️ หน้าเว็บมีคอลัมน์ 10x10cm กับ 15x15cm ด้วย แต่ร้านสั่งถอดออก (21 ส.ค. 69) จึงไม่มีในนี้
 *    apply.mjs ถือรายชื่อที่ถอดไว้ใน SIZES_NOT_OFFERED และเช็คว่ายังมีอยู่บนเว็บจริงก่อนข้าม
 */
export const SIZES = [
  { key: "size-a7", name: "A7", w: 105, h: 74, cols: 4, rows: 4, note: "7.4×10.5 ซม. — ขนาดโปสการ์ดเล็ก" },
  { key: "size-a6", name: "A6", w: 105, h: 148, cols: 4, rows: 2, note: "10.5×14.8 ซม. — ขนาดโปสการ์ด" },
  { key: "size-a5", name: "A5", w: 210, h: 148, cols: 2, rows: 2, note: "14.8×21 ซม. — ครึ่ง A4" },
...
async function foilCards() {
  await saveSvg(
    "foil-none",
    frame(`
    ${title("ไม่เคลือบฟอยล์", "งานพิมพ์สีอย่างเดียว")}
    ${foamCard(305, 280, 290, 380)}
    ${foot(["รวมในราคาการ์ดแล้ว ไม่บวกเพิ่ม", "อยากได้ผิวมันวาว เลือกที่กลุ่ม “เคลือบ” แทนได้"])}`)
  );

  const cards = [
    ["foil-1layer", "พิมพ์ 1 เลเยอร์ / 1 ด้าน", "ฟอยล์ลงบนการ์ดเปล่า — ไม่มีพิมพ์สีรองข้างใต้", false, "url(#gold)", "เงิน · ทอง · โรสโกลด์ (เลือกสีได้)"],
    ["foil-2layer", "พิมพ์ 2 เลเยอร์ / 1 ด้าน", "พิมพ์สีก่อน แล้วปั๊มฟอยล์ทับบนงานพิมพ์", true, "url(#gold)", "เงิน · ทอง · โรสโกลด์ (เลือกสีได้)"],
  ];
