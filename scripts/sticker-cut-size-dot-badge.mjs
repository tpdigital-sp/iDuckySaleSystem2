 ...
 *
 * ⛔ ส่วน "ต่อท้าย badge" เลิกใช้แล้ว — เจ้าของร้านสั่งเอาออก 14 ก.ย. 69 (ป้ายยาวเกิน)
 *    ถอดออกด้วย scripts/cut-size-badge-drop-dot-quota.mjs · ป้ายเหลือแค่ "ได้ N ชิ้น / แผ่น A3"
 *    โควตายังโชว์ครบใต้ช่อง "จำนวนจุดไดคัท" (คิดตามขนาดที่เลือกอยู่) — ข้อมูลไม่หาย
 *    👉 ถ้าจะรันไฟล์นี้ซ้ำเพื่อแก้ note ให้รันแล้วตามด้วย cut-size-badge-drop-dot-quota.mjs --write เสมอ
 *       ไม่งั้นป้ายยาวจะกลับมา
 *
