...
const product: Product = {
  ...
  highlights: [
    ...
    "ตัวเรือนเลือกได้ 2 สี — ขาว | ใส (ฟรีทั้งคู่)",
    "1-10 ชิ้น คละลายได้ · 11 ชิ้นขึ้นไป คละลาย ขั้นต่ำลายละ 5 ชิ้น",
  ...
  options: [
    {
      label: "สีตัวเรือน",
      display: "cards",
      note: "ตัวเรือนพลาสติก เลือกได้ 2 สี **ไม่บวกเงินเพิ่มทั้งคู่** — ลายพิมพ์ UV ตามไฟล์ที่ส่ง",
      choices: [
        {
          name: "สีขาว",
          popular: true,
  ...
  terms: [
    ...
    "ขนาดชิ้นงาน 7.4×3.5 ซม. · วัสดุพลาสติก · ตัวเรือนสีขาว/สีใส ไม่บวกเงินเพิ่ม",
  ...
  tabs: [
    {
      ...
      text: [
        ...
        "• ตัวเรือนเลือกได้ 2 สี — สีขาว | สีใส (ไม่บวกเงินเพิ่มทั้งคู่)",
  ...
  seo: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "เลือกได้ 2 สี — ตัวเรือนสีขาว (พื้นขาว ลายสีสดคมชัด) และตัวเรือนสีใส (มองทะลุได้ เข้ากับเคสใส) ทั้งสองสีไม่บวกเงินเพิ่ม",
      },
      {
