 ...
 *   4. ตาราง "สกรีนมากกว่า 1 จุด" เข้าเป็นแกนที่สองของตาราง (จำนวนจุดที่สกรีน)
...
/**
 * สร้างตารางราคาที่มี 2 แกน (ขนาดสกรีน × จำนวนจุด)
...
const TABS: Product["tabs"] = [
  ...
  },
  {
    ...
    text:
      ...
      '• เลือกระบบพิมพ์ ขนาดสกรีน จำนวนจุด สีเสื้อ และไซส์ แล้วแนบภาพลาย (ไฟล์ตัวอย่าง JPG/PNG) หรือใส่ลิงก์ไฟล์งานในช่อง "แนบลายของคุณ"\n' +
      ...
      "• ระบุรายละเอียด: ระบบพิมพ์ · ขนาดสกรีน · สีเสื้อ · ไซส์และจำนวนแต่ละไซส์ · วันที่ใช้งาน (ถ้ามี)\n" +
...
const product: Product = {
  ...
  description:
    ...
    "มีให้เลือกสีขาวและสีดำ ไซส์ S ถึง 3XL สกรีนได้มากกว่า 1 จุด",
  highlights: [
