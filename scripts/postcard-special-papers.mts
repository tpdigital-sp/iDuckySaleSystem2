 ...
 *
 * ⚠️ ราคากระดาษพิเศษ **ไม่ได้จบที่สคริปต์นี้แล้ว** (ผู้ใช้สั่ง 1 ก.ย. 69) — 6 ชนิดที่มีเนื้อเดียวกัน
 *    บนหน้า texture-paper ไปอิงราคาเรท "ตัดตามขนาด" ของหน้านั้นแทน ต้องรัน
 *    `scripts/postcard-special-papers-from-texture.mts` ตามหลังตัวนี้เสมอ ไม่งั้นราคาจะย้อนกลับ
 *    ไปเท่าแถวอาร์ตมัน 300 แกรม (เหลือ "อาร์ตเกาหลี 300 แกรม" ชนิดเดียวที่ยังอิงแถวนั้นจริง ๆ)
 *
