/* ℹ️ กติกาค่าฐาน 15 ก.ย. 69 (รอบสอง) — กลับมาเป็น 2 ขั้นเหมือนเดิมแล้ว
 * เจ้าของร้าน: "เรทราคา 1-10 ชิ้น ฐานไม่เกิน 6 ซม. ฟรี ตั้งแต่ 7 ซม. เพิ่มเซนละ 5 บาท"
 * ค่าที่ไฟล์นี้ตั้ง (extraFromQty 11 + extraBelow) ตรงกับกติกาปัจจุบันแล้ว
 * แต่ให้ถือ scripts/standee-base-fee-retail-free.mts เป็นตัวจริงของค่าฐาน — รันไฟล์นี้ทับเฉพาะเมื่อรู้ว่าทำอะไรอยู่
 */
#!/usr/bin/env node
/**
