 ...
 *
 * OPTION เสริม (จากใบราคา + กราฟิกบนเว็บ): เก็บขอบเต็มหลา เย็บขอบ +75 / โพ้งขอบ +70 (ด้านยาวสุด 145 ≤150cm)
 *   ตัดแบ่งเป็นชิ้นเล็กคิดต่อชิ้นตามด้านยาวสุด (ตารางอยู่ใน note/แท็บ) — แจ้งขนาดให้แอดมินคิด
...
const OPTIONS: ProductOption[] = [
  ...
  },
  {
    label: GROUP_EDGE,
    display: "cards",
    note: "ราคา +฿ ข้างต้นเป็นค่าเก็บขอบ **เต็มหลา** (ด้านยาวสุด 145 ซม.) · ถ้า**ตัดแบ่งเป็นชิ้นเล็ก** ค่าตัดแบ่ง/เย็บขอบ/โพ้งขอบคิดต่อชิ้นตามด้านที่ยาวที่สุด — ไม่เกิน 30 ซม. ตัดแบ่ง +5 · เย็บ +15 · โพ้ง +10 ไปจนถึง ไม่เกิน 150 ซม. ตัดแบ่ง +25 · เย็บ +75 · โพ้ง +70 บาท/ชิ้น (ดูตารางในแกลเลอรี) · แจ้งขนาดที่ต้องการตัดในช่องหมายเหตุถึงร้าน แอดมินจะคิดราคาให้",
    choices: [
      { name: "ตัดเต็มหลา ไม่เก็บขอบ", badge: "ฟรี", imageSrc: art["edge-none"], desc: "รับผ้าเต็มผืน 145×90 ซม. ขอบตัดเรียบ ไม่เย็บเก็บริม" },
      { name: "เย็บขอบ", extra: 75, imageSrc: art["edge-sew"], desc: "พับเข้าเก็บขอบ ด้านละ 1 ซม. ขอบเรียบหนา เก็บริมเรียบร้อย (เต็มหลา +75 บาท/ผืน)" },
      { name: "โพ้งขอบ", extra: 70, imageSrc: art["edge-serge"], desc: "เย็บโพ้งริมผ้า 4 ด้าน กันลุ่ย ขอบบางกว่าเย็บขอบ (เต็มหลา +70 บาท/ผืน)" },
    ],
  },
  {
    label: GROUP_EYELET,
...
const product: Product = {
  ...
  terms: [
    ...
    "*ค่าตัดแบ่ง / เย็บขอบ / โพ้งขอบ คิดต่อชิ้นตามด้านที่ยาวที่สุดของชิ้นงาน (ตารางราคาอยู่ในแกลเลอรี) — แจ้งขนาดในหมายเหตุถึงร้าน",
  ...
  tabs: [
    ...
    },
    {
      ...
      text: [
        ...
        "• การแบ่งผ้าใน 1 หลา ต้องเหลือพื้นที่สำหรับตัดตกอย่างน้อย 1-2 ซม.",
        "• ผ้าตัดเย็บแต่ละชิ้น ขนาดคลาดเคลื่อน ±0.5-1 นิ้ว",
        "• แจ้งขนาด/จำนวนชิ้นที่ต้องการตัดแบ่งในช่องหมายเหตุถึงร้าน แอดมินจะคิดราคาให้ก่อนยืนยันผลิต",
      ].join("\n"),
    },
    {
      title: "วิธีสั่งงาน",
  ...
  seo: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "ได้ — ค่าตัดแบ่ง/เย็บขอบ/โพ้งขอบคิดต่อชิ้นตามด้านที่ยาวที่สุด เริ่มชิ้นละ +5 บาท (ตัดแบ่ง ≤30 ซม.) จนถึง +75 บาท (เย็บขอบ ≤150 ซม.) การแบ่งผ้าใน 1 หลาต้องเหลือพื้นที่ตัดตกอย่างน้อย 1-2 ซม. แจ้งขนาดที่ต้องการในหมายเหตุถึงร้านได้เลย",
      },
      {
