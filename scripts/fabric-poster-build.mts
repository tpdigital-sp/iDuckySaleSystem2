...
const artSpecs: Record<string, ImgSrc> = {
  ...
  "cut-card-sq2": { kind: "drive", path: new URL("./assets/fabric-poster/cut-card.jpg", import.meta.url).pathname },
  ...
  "eyelet-2top-sq2": { kind: "drive", path: new URL("./assets/fabric-poster/eyelet-top.jpg", import.meta.url).pathname },
  "eyelet-4c-sq2": { kind: "drive", path: new URL("./assets/fabric-poster/eyelet-4r.jpg", import.meta.url).pathname },
...
const OPTIONS: ProductOption[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { name: "เจาะ 2 รู ด้านบน", extra: 10, imageSrc: art["eyelet-2top-sq2"], desc: "ตาไก่ 2 ตัว (1 คู่) มุมบนซ้าย-ขวา สำหรับร้อยเชือกหรือเกี่ยวตะขอแขวนผนัง" },
      { name: "เจาะทั้ง 4 รู", extra: 20, imageSrc: art["eyelet-4c-sq2"], desc: "ตาไก่ 4 ตัว (2 คู่) — 1 คู่ด้านบน และ 1 คู่ด้านล่าง แขวนได้ตึงทั้งผืน" },
    ],
  },
];
