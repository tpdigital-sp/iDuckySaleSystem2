...
const product: Product = {
  ...
  terms: [
    ...
    "*เจาะรูตาไก่ คู่ละ 10 บาท — เจาะ 2 รู ด้านบน (1 คู่ +10 บาท) หรือ เจาะทั้ง 4 ด้าน ด้านละ 1 คู่ (+40 บาท) · ตำแหน่ง/จำนวนแบบอื่นแจ้งในหมายเหตุถึงร้าน",
  ...
  tabs: [
    ...
    },
    {
      ...
      text: [
        ...
        "เจาะรูตาไก่ คู่ละ 10 บาท — เจาะ 2 รู ด้านบน (1 คู่ +10) หรือ เจาะทั้ง 4 ด้าน ด้านละ 1 คู่ (+40) · แบบอื่นแจ้งในหมายเหตุถึงร้าน",
        "",
        "หมายเหตุ::",
        "• การแบ่งผ้าใน 1 หลา ต้องเหลือพื้นที่สำหรับตัดตกอย่างน้อย 1-2 ซม.",
        "• ผ้าตัดเย็บแต่ละชิ้น ขนาดคลาดเคลื่อน ±0.5-1 นิ้ว",
  ...
  seo: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "มีบริการเจาะรูใส่ตาไก่ คู่ละ 10 บาท เลือกได้ในหน้าสินค้า — เจาะ 2 รู ด้านบน (ตาไก่ 1 คู่ +10 บาท) สำหรับร้อยเชือก/เกี่ยวตะขอ หรือ เจาะทั้ง 4 ด้าน (ด้านละ 1 คู่ +40 บาท) ขึงตึงได้ทั้งผืน มีภาพตัวอย่างตำแหน่งเจาะให้ดูตอนเลือก · ต้องการตำแหน่งแบบอื่นแจ้งในหมายเหตุถึงร้าน",
      },
      {
