...
const artSpecs: Record<string, ImgSrc> = {
  ...
  "eyelet-top": { kind: "drive", path: new URL("./assets/fabric-poster/eyelet-top.jpg", import.meta.url).pathname },
  "eyelet-4side": { kind: "drive", path: new URL("./assets/fabric-poster/eyelet-4side.jpg", import.meta.url).pathname },
...
const OPTIONS: ProductOption[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { name: "เจาะ 2 คู่ ด้านบน", extra: 20, imageSrc: art["eyelet-top"], desc: "ตาไก่ 4 ตัว (2 คู่) เรียงขอบบน สำหรับร้อยเชือกหรือเกี่ยวตะขอแขวนผนัง" },
      { name: "เจาะทั้ง 4 ด้าน", extra: 40, imageSrc: art["eyelet-4side"], desc: "ตาไก่ด้านละ 1 คู่ รวม 4 คู่ (8 ตัว) ขึงตึงได้ทั้งผืน เหมาะงานกลางแจ้ง/ผ้าม่าน" },
    ],
  },
];
...
const product: Product = {
  ...
  terms: [
    ...
    "*เจาะรูตาไก่ คู่ละ 10 บาท — เจาะ 2 คู่ ด้านบน (+20 บาท) หรือ เจาะทั้ง 4 ด้าน ด้านละ 1 คู่ (+40 บาท) · ตำแหน่ง/จำนวนแบบอื่นแจ้งในหมายเหตุถึงร้าน",
  ...
  tabs: [
    ...
    },
    {
      ...
      text: [
        ...
        "เจาะรูตาไก่ คู่ละ 10 บาท — เจาะ 2 คู่ ด้านบน (+20) หรือ เจาะทั้ง 4 ด้าน ด้านละ 1 คู่ (+40) · แบบอื่นแจ้งในหมายเหตุถึงร้าน",
        "",
        "หมายเหตุ::",
        "• การแบ่งผ้าใน 1 หลา ต้องเหลือพื้นที่สำหรับตัดตกอย่างน้อย 1-2 ซม.",
        "• ผ้าตัดเย็บแต่ละชิ้น ขนาดคลาดเคลื่อน ±0.5-1 นิ้ว",
  ...
  seo: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "มีบริการเจาะรูใส่ตาไก่ คู่ละ 10 บาท เลือกได้ในหน้าสินค้า — เจาะ 2 คู่ ด้านบน (ตาไก่ 4 ตัว +20 บาท) สำหรับร้อยเชือก/เกี่ยวตะขอ หรือ เจาะทั้ง 4 ด้าน (ด้านละ 1 คู่ +40 บาท) ขึงตึงได้ทั้งผืน มีภาพตัวอย่างตำแหน่งเจาะให้ดูตอนเลือก · ต้องการตำแหน่งแบบอื่นแจ้งในหมายเหตุถึงร้าน",
      },
      {
