...
/** ชาร์ตสีของร้านกำกับ C-02 ว่า "ไม่บวกเพิ่ม" — ราคาเท่าใส จึงอยู่เรทมาตรฐาน ไม่ใช่สีพิเศษ */
 ...
 * ราคาตามตารางได้เฉพาะอะคริลิคใสกับขาวขุ่น C-02 สีอื่นทั้งหมดจึงเป็นของพิเศษที่ร้านตีราคาให้
 * (C-02 ต้องไม่อยู่ในลิสต์นี้ ไม่งั้นวัสดุเดียวกันมีสองราคา — เรทมาตรฐานกับเรทให้ร้านตีราคา)
 */
const SPECIAL_COLORS: string[] = Object.keys(COLORS as Record<string, unknown>).filter((name) => name !== C02);
