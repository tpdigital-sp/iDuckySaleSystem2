...
const MAP = {
  ประเภทอะคริลิค: { อะคริลิคใส: "clear-plain-v2" },
  // ดรอปดาวน์สีก็มี "อะคริลิคใส" ที่ไม่มีสวอตช์ในชาร์ตสีกลาง — ใช้ภาพเดียวกัน
  สีอะคริลิค: { อะคริลิคใส: "clear-plain-v2" },
  ขนาด: {
    "5 cm": "size-5-v1",
    "6cm": "size-6-v1",
    "7cm": "size-7-v1",
  ...
  อะไหล่: { "เล็ก (ขนาด 1.8 cm)": "part-small-v1", "ใหญ่ (ขนาด 2.8 cm)": "part-large-v1" },
  สกรีน: { "1 ด้าน": "print-1-v1", "2 ด้าน": "print-2-v1" },
  เพิ่มก้านตะขอ: { ชิ้นละ: "hook-extra-v1" },
};
