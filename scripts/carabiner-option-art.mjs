...
const MAP = {
  ประเภทอะคริลิค: { อะคริลิคใส: "clear-plain-v4" },
  // ดรอปดาวน์สีก็มี "อะคริลิคใส" ที่ไม่มีสวอตช์ในชาร์ตสีกลาง — ใช้ภาพเดียวกัน
  สีอะคริลิค: { อะคริลิคใส: "clear-plain-v4" },
  ขนาด: {
    "5 cm": "size-5-v3",
    "6cm": "size-6-v3",
    "7cm": "size-7-v3",
  ...
  อะไหล่: { "เล็ก (ขนาด 1.8 cm)": "part-small-v3", "ใหญ่ (ขนาด 2.8 cm)": "part-large-v3" },
  สกรีน: { "1 ด้าน": "print-1-v3", "2 ด้าน": "print-2-v3" },
  เพิ่มก้านตะขอ: { ชิ้นละ: "hook-extra-v3" },
};
