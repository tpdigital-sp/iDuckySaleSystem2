 ...
 *
 * ⚠️ สคริปต์นี้ "ไม่แตะ" data.rules — กฎที่อ้างชื่อรวมเดิมจะกลายเป็นกฎตายเงียบ ๆ
 *    เคยทำพวงกุญแจพัง: กฎ "หนา 3mm → ประเภทอะคริลิค ได้แค่ [ใส / ขาวขุ่น C-02, สีพิเศษ]"
 *    เหลืออนุญาตแค่สีพิเศษ → แกนราคาถูกล็อกเป็นสีพิเศษ (฿90 แทน ฿80) และใส/C-02 หายจากรายการสี
 *    แยกกลุ่มไหนแล้ว ไล่ดู rules ที่มีชื่อกลุ่มนั้นทุกตัวด้วย (ดู scripts/fix-keyring-acrylic-rules.mjs)
 */
