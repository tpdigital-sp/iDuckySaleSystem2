 ...
 *
 * ⚠️ เคยมีช่วง "ไม่เกิน 20 × 20 ซม." (2 อัน/แผ่น A3) แต่ร้านสั่งถอดออก 21 ส.ค. 69
 *    ช่วงใหญ่สุดที่เหลือจึงเล็กกว่าที่หน้าเว็บบอกว่าทำได้ — ตั้งใจให้เป็นแบบนั้น อย่าเผลอเติมกลับ
 *    (งานที่ใหญ่กว่าช่วงในลิสต์ ให้ลูกค้าทักแอดมิน — เขียนบอกไว้ในคำกำกับกลุ่มแล้ว)
 */
export const SIZES = [
  { key: "size-14", name: "ไม่เกิน 14 × 14 ซม.", mm: 140, cols: 3, rows: 2, note: "ขนาดกลาง — พอดีมือ", popular: true },
