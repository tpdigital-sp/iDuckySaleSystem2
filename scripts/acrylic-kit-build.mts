 ...
 *   [1] ACRYLIC KIT (ตัวนี้) · [2] ACRYLIC KIT + Magnet (คนละสินค้า — แม่เหล็กจุดละ 8 ไม่เอามาผูก)
...
const product: Product = {
  ...
  highlights: [
    ...
    "ชิ้นงานไม่เกิน 5 ชิ้น/ชุด ถอดประกอบ-แต่งตัวได้ · ทำสแตนดี้รูเสียบ (+20 บาท) หรือใส่อะไหล่พวงกุญแจได้",
  ],
  options: OPTIONS,
  images: gallery,
  pricing,
  ...
  terms: [
    ...
    "*หากต้องการอะไหล่พวงกุญแจ หรือแบบติดแม่เหล็ก (จุดละ 8 บาท) รบกวนแจ้งในหมายเหตุถึงร้าน",
  ...
  tabs: [
    {
      ...
      text: [
        ...
        "• ต้องการแบบติดแม่เหล็กเฉพาะจุด (Acrylic Kit Magnet) แม่เหล็กขนาด 3 มม. จุดละ 8 บาท — แจ้งในหมายเหตุถึงร้าน",
  ...
  seo: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "ได้ — แม่เหล็กขนาด 3 มม. คิดเพิ่มจุดละ 8 บาท จุดที่ติดแม่เหล็กต้องมีขนาดมากกว่า 1 ซม. แจ้งในหมายเหตุถึงร้านว่าต้องการติดแม่เหล็กตำแหน่งไหนบ้าง",
      },
    ],
  },
