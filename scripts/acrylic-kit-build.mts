 ...
 *   • รูเสียบสแตนดี้ ไม่ทำเป็นกลุ่มตัวเลือก (ผู้ใช้สั่งถอด 25 ส.ค. 69) — กติกาเว็บ (1-2 รู +20 ·
 *     เกินนั้นรูละ +10 · สูงสุด 5 รู) อยู่ใน terms/แท็บ/FAQ ให้ลูกค้าแจ้งในหมายเหตุถึงร้าน
 *
...
const OPTIONS: ProductOption[] = [
  ...
  // ⛔ กลุ่ม "รูเสียบสแตนดี้" ถอดออกตามผู้ใช้สั่ง 25 ส.ค. 69 — งานสแตนดี้รูเสียบยังรับทำ
  //    (1-2 รู +20 · เพิ่มรูละ 10 · สูงสุด 5 รู) แต่ให้ลูกค้าแจ้งในหมายเหตุถึงร้านแทน (อยู่ใน terms/แท็บ/FAQ)
  {
  ...
  seo: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "ได้ทั้งคู่ — แบบสแตนดี้รูเสียบ ค่าทำพิเศษ 1-2 รูเสียบ +20 บาท/ชุด เพิ่มรูละ 10 บาท สูงสุด 5 รู ส่วนอะไหล่พวงกุญแจก็ใส่ได้ ทั้งสองแบบแจ้งในหมายเหตุถึงร้านได้เลย",
      },
      {
