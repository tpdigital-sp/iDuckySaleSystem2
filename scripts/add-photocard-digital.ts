...
const product: Product = {
  ...
  description:
    ...
    "เลือกวัสดุได้ 3 แบบ — กระดาษอาร์ตมัน 300 แกรม (นำเข้าจากเกาหลี), กระดาษเนื้อพิเศษ (โฮโลแกรม / Canvas / Egg Shell / 100 Pond / Extra White) " +
  ...
  priceRates: [
    ...
    },
    {
      id: "paper-special",
      label: RATE_SPECIAL,
      desc: "โฮโลแกรม | Canvas | Egg Shell | 100 Pond | Extra White · ฟรี! ไดคัทมุมมน + เคลือบเงา/ด้าน",
  ...
  options: [
    {
      ...
      choices: [
        ...
        { name: "Egg Shell 280 แกรม", imageSrc: IMG("paper-eggshell") },
