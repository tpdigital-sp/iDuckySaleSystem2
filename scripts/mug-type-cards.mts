/**
 * แก้วมัค 11 ออนซ์ (mug-11oz): กลุ่ม "ประเภท" (แก้วขาวเงา/ใส/ขาวขุ่น · เปลี่ยนชื่อจาก "แก้วขาว" 17 ก.ย. 69 ดู mug-white-glossy-rename.mjs) → การ์ดมีรูป+คำอธิบาย
...
const CARD: Record<string, { img: string; desc: string }> = {
  "แก้วขาวเงา": { img: art["type-white"], desc: "แก้วเซรามิกขาวทึบ สีพิมพ์สดชัดที่สุด — แบบมาตรฐานที่นิยมสั่ง" },
  "แก้วใส": { img: art["type-clear"], desc: "แก้วใสมองทะลุได้ งานพิมพ์เป็นสีโปร่งแสง — ลายสีอ่อนจะมองเห็นยาก" },
  "แก้วขาวขุ่น": { img: art["type-frosted"], desc: "แก้วเนื้อขุ่นผิวฝ้า ลุคนุ่มละมุน — สีพิมพ์อ่อนกว่าแก้วขาวเงาราว 30-50%" },
};
