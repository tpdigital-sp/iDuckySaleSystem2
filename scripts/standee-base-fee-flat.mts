/**
 * ⛔ ห้ามรันทับงานสแตนดี้อีก (เจ้าของร้านกลับคำ 15 ก.ย. 69 ตอนบ่าย)
 * "เรทราคา 1-10 ชิ้น ฐานไม่เกิน 6 ซม. ฟรีค่ะ ตั้งแต่ 7 ซม. เพิ่มเซนละ 5 บาท"
 * → งานสแตนดี้ 7 ตัวย้อนกลับไปใช้ 2 ขั้นแล้วด้วย scripts/standee-base-fee-retail-free.mts
 *   รันสคริปต์นี้ทับ = ค่าฐานปลีกกลับไปคิดเต็มอีกรอบ
 * เหลือแค่ photo-fram-acrylic (กรอบใส่รูป) ที่ยังใช้กติกาปลีก=ส่งตามไฟล์นี้
 */
/**
