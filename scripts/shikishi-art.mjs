...
export const SIZES = [
  ...
  // ⚠️ 2 ขนาดจัตุรัสหน้าเว็บไม่ได้บอกจำนวนใบต่อแผ่น A3 — คำนวณจากพื้นที่แผ่น A3 (29.7×42 ซม.)
  //    10×10 = 2 คอลัมน์ × 4 แถว · 15×15 = 1 × 2 · ค่าเคลือบ/ฟอยล์คิดจากตัวเลขนี้ ให้ร้านยืนยันอีกที
  { key: "10x10cm", mm: [100, 100], perA3: 8, note: "จัตุรัสเล็ก — ลายวงกลม/โลโก้ลงตัว" },
  { key: "15x15cm", mm: [150, 150], perA3: 2, note: "จัตุรัสกลาง — ตั้งโชว์คู่กับกรอบได้" },
];
...
async function sizeCards() {
  ...
  for (const s of SIZES) {
    ...
    const svg = frame(`
      ...
      ${foot([
        `ค่าเคลือบ/ฟอยล์คิดเป็นแผ่น A3 — ขนาดนี้ได้ ${s.perA3} ใบ ต่อ 1 แผ่น A3`,
