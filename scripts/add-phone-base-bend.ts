...
const product: Product = {
  ...
  terms: [
    "ขนาดมาตรฐาน สูงประมาณ 14 ซม. · ฐานกว้าง 8 ซม. — เพิ่มขนาด บวกเพิ่ม ซม. ละ 10 บาทต่อชิ้น",
    "จุดดัดงอ 3 จุด — ขนาดเป็นขนาดโดยประมาณ ขึ้นอยู่กับการดัดง้อ แต่ละชิ้นอาจไม่เท่ากัน ความสูงเริ่มวัดจากพื้นฐาน",
