...
function baseArt(b) {
  ...
  return frame(`
    ...
    ${foot([
      ...
      "ราคาฐานคิดตามขนาด — ระบบรวมให้ในตารางราคาแล้ว",
    ])}`);
}
...
const baseScreenNo = frame(`
  ...
  ${slot(350, 378)}
  ${foot(["ฐาน 6-7 ซม. +15 · 8 ซม. +20 · 9 ซม. +25 บาท", "ฐาน 10 ซม. +30 · 11 ซม. +35 · 12 ซม. +40 บาท"])}`);
...
const baseScreenYes = frame(`
  ...
  ${slot(350, 378)}
  ${foot(["ฐาน 6-7 ซม. +25 · 8 ซม. +30 · 9 ซม. +35 บาท", "ฐาน 10 ซม. +40 · 11 ซม. +45 · 12 ซม. +50 บาท"])}`);
