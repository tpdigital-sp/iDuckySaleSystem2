    ...
    <div className="shopp">
      ...
      <div className="ord-card p-5 sm:p-6">
        ...
        */}
        ...
        {/*
          🛒 งานนี้รอสินค้าเข้าร้านก่อนผลิต (แอดมินติ๊ก "รอของเข้า") — บอกลูกค้าแบบสุภาพ ไม่ให้สงสัยว่าทำไมสถานะนิ่ง
          ⚠️ ต้องอยู่ในการ์ดหัวใบ ติดใต้แถบวันที่จัดส่ง — เดิมวางในคอลัมน์ข้างใต้กล่องทักไลน์ เจ้าของร้านเปิดแล้ว "ยังไม่เห็นมีแจ้ง" (17 ก.ย. 69)
          ก้อนที่ส่งมาหน้าลูกค้ามีแค่ at/arrivedAt (customerSafeOrder ตัดโน้ตภายในทิ้งแล้ว) · เข้าไลน์ผลิตแล้ว = ไม่ต้องบอกอีก
        */}
        {order.needsPurchase && !cancelled && !["กำลังผลิต", "จัดส่งแล้ว", "เสร็จสิ้น"].includes(order.status) &&
          (order.needsPurchase.arrivedAt ? (
            <div className="ord-note ok mt-3 p-4">
              <p className="ord-title text-[1rem]" style={{ color: "inherit" }}>✅ สินค้าสำหรับงานนี้เข้าร้านแล้ว</p>
              <p className="mt-1 text-[13px] leading-relaxed">พร้อมเริ่มผลิตทันทีที่แบบงานได้รับการอนุมัติครับ</p>
            </div>
          ) : (
            <div className="ord-note info mt-3 p-4">
              <p className="ord-title text-[1rem]" style={{ color: "inherit" }}>📦 งานนี้รอสินค้าเข้าร้านก่อนเริ่มผลิต</p>
              <p className="mt-1 text-[13px] leading-relaxed">
                {order.status === "รอชำระเงิน" || order.status === "รอตรวจสอบ"
                  ? "สินค้าสำหรับงานนี้ทางร้านต้องสั่งเข้ามาให้โดยเฉพาะ — จะสั่งของทันทีหลังได้รับยอดชำระ และแจ้งทางไลน์เมื่อของเข้าร้านครับ"
                  : "ทางร้านกำลังสั่งสินค้าสำหรับงานนี้อยู่ครับ ระหว่างรอของเข้า ทีมกราฟฟิกทำแบบให้ตรวจได้ตามปกติ — จะแจ้งทางไลน์ทันทีที่ของเข้าร้านและเริ่มผลิตครับ"}
              </p>
            </div>
          ))}
