        ...
        <Bullets
          items={[
            ...
            <>
              ...
              เป็น QR เหมือนบนใบงาน ใช้ตอนยังไม่ได้ปริ้น (ไม่มีบาร์โค้ดในจอ)
            </>,
            <>
      ...
      <>
        ...
        <div className="grid gap-3 lg:grid-cols-2">
          ...
          <div>
            ...
            <Shot caption="การ์ด “ใบงาน · การจัดส่ง” → บล็อก 📱 สแกนเปิดบนมือถือ">
              <ShotImg src="/guide/qr-on-screen.png" alt="QR ในหน้าออเดอร์" max="20rem" />
            </Shot>
          </div>
        </div>
        <p className="text-[0.85rem] text-slate-500">
          ทั้งสองจุดเป็น QR เหมือนกัน สแกนแล้วเปิดหน้าออเดอร์เดียวกัน — ต่างกันแค่<B>ยังไม่ได้ปริ้นใบงานก็ใช้จากจอได้</B>
        </p>
