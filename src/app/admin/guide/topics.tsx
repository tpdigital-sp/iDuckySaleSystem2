...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    group: "setup",
    icon: "🧭",
    title: "เมนูหน้าร้าน — จัดการ์ดนำทางเอง",
    roles: ["แอดมิน", "คอนเทนต์"],
    keywords: "เมนู navigator นำทาง การ์ด หน้าแรก แถบเมนู ลิงก์ แบนเนอร์ ทางลัด แก้เมนู เพิ่มเมนู",
    body: (
      <>
        <Shot caption="ตัวอย่างในหน้าแก้ไข — เห็นยังไง ลูกค้าเห็นอย่างนั้น">
          <ShotImg src="/guide/nav-preview.jpg" alt="ตัวอย่างแถบเมนูและการ์ดนำทาง" max="34rem" />
        </Shot>
        <p>
          <A href="/admin/nav">เมนูหน้าร้าน</A> คุมทางลัดที่ลูกค้าเห็น <B>2 จุด</B> — ไม่ต้องให้โปรแกรมเมอร์แก้โค้ด
        </p>
        <Bullets
          items={[
            <>
              <B>แถบเมนูด้านบน</B> — ลิงก์ข้างโลโก้ (หน้าแรก · สินค้าทั้งหมด · วิธีสั่งซื้อ) อยู่ทุกหน้า ·
              บนมือถือจะไปรวมอยู่ในปุ่ม ☰
            </>,
            <>
              <B>การ์ดนำทางบนหน้าแรก</B> — บล็อกใหญ่ใต้แบนเนอร์ ให้ลูกค้ากดไปหน้าที่ใช้บ่อยได้เลย
            </>,
          ]}
        />
        <Shot caption="แก้การ์ด 1 ใบ">
          <ShotImg src="/guide/nav-editor.png" alt="ช่องแก้ไขการ์ดนำทาง" max="34rem" />
        </Shot>
        <Steps
          items={[
            <>
              <B>ขนาดการ์ด</B> — <Mark>ใหญ่</Mark> อยู่ซ้ายสูง 2 แถว · <Mark>กว้าง</Mark> เป็นแถบยาว ·{" "}
              <Mark>เล็ก</Mark> เรียงต่อกันได้ 3 ใบ · ชุดที่สวยที่สุดคือ <B>ใหญ่ 1 + กว้าง 1 + เล็ก 3</B>
            </>,
            <>
            ...
            <>
              <B>ใส่รูปการ์ด</B> — มีภาพที่ออกแบบมาแล้ว (มีตัวหนังสือในภาพ) อัปโหลดได้เลย
              ระบบจะใช้รูปเต็มใบแทนพื้นสีและตัวหนังสือ
            </>,
            <>
              ปุ่ม <Mark>👁 แสดงอยู่</Mark> = ซ่อนชั่วคราวโดยไม่ต้องลบ · ลูกศร <Key>↑</Key> <Key>↓</Key> ใช้สลับลำดับ
            </>,
            <>
              กด <B>💾 บันทึก</B> — ลูกค้าเห็นทันที ไม่ต้องรอ deploy
            </>,
          ]}
        />
        <Tip>
          ตัวอย่างด้านบนของหน้าแก้ไขใช้ตัวเดียวกับหน้าร้านจริง — ลองปรับดูก่อนกดบันทึกได้ ยังไม่กดบันทึกลูกค้าก็ยังไม่เห็น
        </Tip>
        <Warn>
          ลบจนไม่เหลือสักใบ ระบบจะกลับไปใช้<B>ชุดเริ่มต้น</B>แทน (กันหน้าแรกโล่ง) — ถ้าจะไม่เอาการ์ดจริง ๆ
          ให้ติ๊กออกที่ <Mark>แสดงการ์ดนำทางบนหน้าแรก</Mark>
        </Warn>
      </>
    ),
  },
