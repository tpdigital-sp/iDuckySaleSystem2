  ...
  },
  {
    ...
    body: (
      <>
        ...
        <div className="grid gap-2">
          {[
            ["จ่ายยังไงได้บ้าง?", "โอนเข้าบัญชีธนาคารร้าน หรือพร้อมเพย์ แล้วแนบสลิปในหน้าออเดอร์"],
            ...
            ["สั่งแล้วเปลี่ยนที่อยู่ได้ไหม?", "แก้เองได้ในหน้าออเดอร์ จนกว่าร้านจะปริ้นใบงาน"],
            ["อยากสั่งเพิ่มทีหลัง?", "กด “สั่งเพิ่มในออเดอร์นี้” ในหน้าออเดอร์เดิม — ไม่คิดค่าส่งซ้ำ (ถ้ายังไม่เข้าผลิต)"],
        ...
        <Warn>
          <B>ระบบรับเงินทางเดียว — โอน/พร้อมเพย์ แล้วแนบสลิป</B> · ทุกออเดอร์ที่ลูกค้าสั่งเองจะถูกบันทึกเป็น
          “โอนธนาคาร” เสมอ · <Mark>ยังไม่มีบัตรเครดิต และไม่มีเก็บเงินปลายทาง (COD)</Mark> —
          ถ้าลูกค้าถามถึง ให้ตอบว่ายังไม่รองรับ
        </Warn>
        <Tip>
