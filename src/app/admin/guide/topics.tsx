    ...
    body: (
      <>
        ...
        <Bullets
          items={[
            <>
              <B>บนใบปะหน้าพัสดุ</B> (ครึ่งบนที่ติดกล่อง) — <B>บาร์โค้ดจุดเดียวในระบบ</B> ที่เครื่องยิง 1D อ่านได้
              อยู่มุมขวา ใต้ชื่อวิธีจัดส่ง
            </>,
            <>
              <B>บนใบงาน</B> (ครึ่งล่างที่เก็บไว้) — <B>QR</B> สำหรับกล้องมือถือ
            </>,
            <>
            ...
            <>
              ...
              ใช้ตอนใบงานยังไม่ปริ้น (เป็น QR สำหรับมือถือ ไม่ใช่บาร์โค้ดสำหรับเครื่องยิง)
            </>,
            <>
