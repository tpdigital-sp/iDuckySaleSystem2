    ...
    body: (
      <>
        ...
        <Bullets
          items={[
            <>
              <B>บนใบปะหน้าพัสดุ</B> (ครึ่งบนที่ติดกล่อง) — บาร์โค้ดมุมขวา ใต้ชื่อวิธีจัดส่ง สำหรับ<B>เครื่องยิง</B>
            </>,
            <>
              <B>บนใบงาน</B> (ครึ่งล่างที่เก็บไว้) — <B>QR</B> สำหรับกล้องมือถือ
            </>,
            <>
              ออเดอร์<B>มัดจำที่ยังเก็บเงินไม่ครบ</B> ใบปะหน้าไม่พิมพ์ = <Mark>ไม่มีบาร์โค้ดบนกระดาษ</Mark> —
              ให้ยิงจากจอแทน (บล็อกด้านล่าง) หรือสแกน QR ด้วยมือถือ
            </>,
            <>
