    ...
    body: (
      <>
        ...
        <Bullets
          items={[
            <>
              <B>บนใบงานที่ปริ้นออกมา</B> — มีบาร์โค้ด <B>2 จุด</B> เพราะกระดาษถูกตัดแยกครึ่ง:
              ตัวบน<B>ติดไปกับกล่อง</B> · ตัวล่างอยู่กับ<B>ใบงานที่เราเก็บไว้</B> ตัดแล้วยังยิงได้ ·
              QR อยู่ข้างบาร์โค้ดตัวล่าง
            </>,
            <>
              ออเดอร์<B>มัดจำที่ยังเก็บเงินไม่ครบ</B> ใบปะหน้าไม่พิมพ์ — แต่บาร์โค้ดบนใบงาน<Mark>ยังมีให้ยิงเสมอ</Mark>
            </>,
            <>
