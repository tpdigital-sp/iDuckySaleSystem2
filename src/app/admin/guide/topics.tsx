...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    group: "setup",
    icon: "✍️",
    title: "เขียนบทความขึ้นหน้าเว็บ",
    roles: ["แอดมิน", "คอนเทนต์"],
    keywords: "บทความ blog เขียน คอนเทนต์ seo article เผยแพร่ ฉบับร่าง",
    body: (
      <>
        <p>
          <A href="/admin/articles">บทความ</A> (กลุ่มเมนู 💛 ลูกค้า & การตลาด) — เขียนแล้วขึ้นหน้าเว็บ{" "}
        ...
        <Steps
          items={[
            ...
            <>
              เนื้อหาเขียนเป็น<B>ท่อน ๆ</B> (หัวข้อ + ข้อความ + รูป) แบบเดียวกับเนื้อหาสินค้า ·
              กด Enter ขึ้นบรรทัดใหม่ได้เลย หน้าเว็บขึ้นตาม
            </>,
            <>
              <B>💾 บันทึกร่าง</B> = เก็บไว้ก่อน ลูกค้ายังไม่เห็น · <B>🚀 เผยแพร่</B> = ขึ้นเว็บจริง ·
              กด "พักเป็นฉบับร่าง" เพื่อซ่อนชั่วคราวได้
            </>,
            <>
              <B>เกริ่นสั้น ๆ</B> สำคัญกับ Google — ระบบใช้เป็นคำอธิบายในผลค้นหา · ใส่รูปปกช่วยให้แชร์ขึ้น LINE/Facebook สวย
            </>,
          ]}
        />
        <Tip>
  ...
  },
  {
    ...
    group: "product",
    icon: "🪜",
    title: "หลายเรทราคา + คละลาย (เช่น พิน)",
    roles: ["คอนเทนต์", "แอดมิน"],
    keywords: "หลายเรท เรทราคา เรท 1 เรท 2 คละดีเทล ไม่คละดีเทล คละลาย ขั้นต่ำ ลายละ พิน ราคาส่ง คละเกินโควตา ค่าคละลาย อะคริลิคพิเศษ",
    body: (
      <>
        <p>
          สินค้าบางตัว (เช่น พิน) มี<B>เรทราคาหลายชุด</B> เงื่อนไขคนละแบบ — เรท 1 คละดีเทลได้ สั่งน้อยได้ ·
          เรท 2 ราคาส่งถูกกว่า แต่<Mark>สั่งรวมขั้นต่ำ 50 ชิ้น และคละลายขั้นต่ำลายละ 25 ชิ้น</Mark> ·
          ลูกค้าเลือกเรทเองบนหน้าสินค้า ระบบล็อกขั้นต่ำ/สลับตารางราคาให้อัตโนมัติ
        </p>
        <Steps
          items={[
            <>
            ...
            <>
              กด <Key>＋ เพิ่มเรทราคา</Key> → ตั้ง<B>ชื่อเรท</B>ที่ลูกค้าเห็น (เช่น “เรทที่ 2 แบบไม่คละดีเทล”) +
              คำอธิบายสั้น ๆ
            </>,
            <>
              ใส่เงื่อนไขของเรทนั้น: <B>สั่งรวมขั้นต่ำ</B> (เช่น 50) และ <B>คละลายขั้นต่ำลายละ</B> (เช่น 25) —
              ลูกค้าสั่ง 50 ชิ้นจะเห็นเองว่า “คละได้ 2 ลาย”
            </>,
            <>
              ตั้ง<B>ช่วงจำนวนของเรทนี้เอง</B>ได้เลย (เช่น 50-100 · 101-199 · 200-4,999) ไม่ต้องเหมือนเรทแรก
              แล้วกรอกราคาในตาราง
            </>,
            <>
              <Mark>ต้องกด 💾 บันทึก</Mark>ที่หน้าแก้ไขสินค้าเหมือนเดิม แล้วเปิดหน้าร้านเช็ค 1 รอบ —
              การ์ดเลือกเรทจะโผล่เหนือตัวเลือกสินค้า
            </>,
          ]}
        />
        <p>
          <B>🎨 คละลายเกินโควตา (คิดเพิ่มต่อลาย)</B> — บางสินค้าใจดีให้คละเกินได้ เช่น จ่ายเพิ่มลายละ 10 บาท:
          ใส่ช่อง <Key>คละเกินโควตา ลายละ +฿</Key> ของเรทนั้น · ลูกค้าจะได้ปุ่ม “คละกี่ลาย” บนหน้าสินค้า —
          <Mark>ระบบนับให้อัตโนมัติตามจำนวนรูปลายที่ลูกค้าแนบ</Mark> (ปรับมือได้ เพราะลาย 1 แบบอาจแนบหลายมุม)
          เกินโควตาแล้วระบบบวกเงินให้เอง (ขึ้นเป็นบรรทัด “ค่าคละลายเพิ่ม” แยกในออเดอร์) ·
          แนบรูปมากกว่าจำนวนลายที่นับไว้ → หน้าเว็บเตือนลูกค้าเอง ·
          <Mark>เว้นว่าง = คละเกินไม่ได้</Mark> อยากได้ลายเพิ่มต้องเพิ่มจำนวนสั่งอย่างเดียว
        </p>
        <Tip>
          <B>Option วัสดุพิเศษ</B> (เช่น อะคริลิคพิเศษ +10/ชิ้น) ไม่ต้องมีระบบแยก — เพิ่มกลุ่มตัวเลือก
          “ชนิดอะคริลิค” แล้วติ๊กเป็น<B>คอลัมน์อิงตามกลุ่ม</B> คอลัมน์จะแตกเป็น ขนาด×ชนิด
          ให้กรอกราคาที่บวกเพิ่มแล้วในแต่ละเรทได้เลย
        </Tip>
        <Bullets
          items={[
            <>
              <B>จำนวนเด้งเรทให้เอง</B> — ลูกค้าใส่จำนวนถึงขั้นต่ำของเรทไหน ระบบสลับไปเรทนั้นอัตโนมัติ
              (ลูกค้ากดเลือกเรทเองเมื่อไหร่ = ระบบเคารพที่เลือก ไม่สลับให้อีก)
            </>,
            <>
              <B>เรทไหนไม่ขายบางตัวเลือก</B> (เช่น เรทส่งไม่มี 2cm) — กด <Key>✕</Key> ท้ายแถวนั้นเพื่อ
              <Mark>ล้างราคาทั้งแถว</Mark> · แถวว่าง = ตัวเลือกนั้นถูกซ่อนจากลูกค้าเมื่ออยู่เรทนั้น
            </>,
            <>
              <B>ราคาบวกเพิ่มต่อตัวเลือก</B> — กลุ่มที่ไม่ได้เป็นคอลัมน์ตาราง (เช่น อะไหล่เข็มกลัด)
              ใส่ช่อง <Key>+฿</Key> หลังชื่อตัวเลือกได้ เช่น P4 +5 = บวกเพิ่ม 5 บาท/ชิ้นทุกเรท
              (ปุ่มหน้าร้านโชว์ “P4 +฿5” ให้เอง)
            </>,
            <>
              <B>ช่วงปลีกคละลายอิสระ</B> — ตั้ง <Key>คละอิสระเมื่อต่ำกว่า (ชิ้น)</Key> ของเรทได้
              เช่น ใส่ 11 = สั่ง 1-10 ชิ้น (ปลีก) คละลายได้ทุกชิ้นไม่ติดขั้นต่ำต่อลาย ไม่คิดค่าคละเพิ่ม ·
              ตั้งแต่ 11 ชิ้นค่อยใช้กติกา &quot;ขั้นต่ำลายละ&quot; ตามปกติ
            </>,
            <>
              <B>ปลีกราคารวมอะไหล่แล้ว</B> — ตั้ง <Key>+฿ มีผลเมื่อสั่งครบ N ชิ้นขึ้นไป</Key> ที่หัวกลุ่มได้
              เช่น ใส่ 11 = สั่ง 1-10 ชิ้น (ปลีก) ราคารวมอะไหล่แล้วไม่บวกเพิ่ม · 11 ชิ้นขึ้นไปค่อยคิด
              +฿ ตามตัวเลือก (หน้าร้านซ่อน +฿ และแจ้งลูกค้าให้เอง)
            </>,
          ]}
        />
        <Warn>
