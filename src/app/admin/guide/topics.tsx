      ...
      <>
        ...
        <Bullets
          items={[
            ...
            <>
              <Mark>ยังเก็บเงินไม่ครบ = พิมพ์ใบเสร็จไม่ได้</Mark> ช่องจะถูกปิดไว้ (รวมออเดอร์มัดจำที่ค้างยอดหลัง)
            </>,
            <>ระบบจำว่าใบงานนี้ปริ้นไปแล้วกี่ครั้ง ใครปริ้น — กันปริ้นซ้ำแล้วของไปสองรอบ</>,
          ]}
        />
      </>
    ),
