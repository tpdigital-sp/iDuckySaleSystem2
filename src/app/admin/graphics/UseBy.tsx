...
/**
 * วันใช้งานที่ลูกค้าแจ้งมา (Order.useByDate) — ตัวนับวัน + ป้ายม่วง 📅 วันที่จริง
 ...
 * ไม่ได้ระบุวันใช้งาน → ป้ายเหลืองตัวหนา "⚠ ไม่ระบุวันใช้งาน" ให้สะดุดตาว่าต้องถามลูกค้า
