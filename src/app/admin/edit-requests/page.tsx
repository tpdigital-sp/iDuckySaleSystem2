 ...
 *
 * 💰 หน้านี้เอาเฉพาะใบที่ชำระเงินแล้วเป็นต้นไป (เจ้าของร้านสั่ง 22 ก.ย. 69) — ใบที่ยังไม่มีเงินเข้า
 * ลูกค้ายกเลิกแล้วสั่งใหม่เองได้ ไม่ต้องมาค้างเป็นงานของทีม · กรองที่ API ป้ายเลขข้างเมนูจึงตรงกัน
 *
  ...
  return (
    <PageShell>
      <PageHead
        ...
        sub="ลูกค้ากด “ขอแก้ไขออเดอร์นี้” จากหน้าออเดอร์ของตัวเอง — เปิดออเดอร์ แก้รายการ/ราคาให้ แจ้งยอดใหม่กับลูกค้า แล้วกด “จัดการแล้ว” · แสดงเฉพาะใบที่ชำระเงินแล้วเป็นต้นไป"
      />
      ...
      <ListHead title="คำขอจากลูกค้า" note="ใหม่สุดขึ้นก่อน · เฉพาะใบที่ชำระเงินแล้วเป็นต้นไป" />
      ...
      {shown.length === 0 ? (
        <Empty
          ...
          body={
            filter === "open"
              ? "เคลียร์หมดแล้ว — คำขอใหม่จากใบที่ชำระเงินแล้วจะขึ้นตรงนี้ทันทีที่ลูกค้าส่งเข้ามา"
