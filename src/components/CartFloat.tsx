 ...
 * ทั้งปุ่มตอนนี้คือรูปเดียว /landing/cart-shop-badge-v4.webp
 *
 * 22 ก.ย. 69 — เจ้าของร้านส่ง "ภาพกองปุ่มชุดใหม่" มาทั้งแผ่น (4 ใบในภาพเดียว) แล้วสั่งสั้น ๆ ว่า
 * "นำภาพที่ 1 ไปใส่แทนที่ภาพที่ 2" = เปลี่ยนทั้งกองพร้อมกัน ไม่ใช่ทีละใบ · ส่งมา 2 รอบในวันเดียว (v3 → v4)
 * ใบนี้ของใหม่มีบรรทัดรอง "เลือกของดี ๆ ใส่ตะกร้ากันเลย" + ลูกศรในวงกลม แคปซูลจึงหนาขึ้น
 * ทรงแต่ละรอบไม่เท่ากัน ระยะใน landing.css ต้องวัดใหม่ทุกรอบ —
 * `node scripts/fab-badges-from-sheet.mjs` ตัดภาพ + พิมพ์เลข width/height/right/bottom ให้ครบทั้ง 4 ใบ
 * ⚠️ ชื่อไฟล์ลงท้าย -v4 เพราะทับพาธเดิมแล้ว CDN/เบราว์เซอร์ยังจ่ายรูปเก่า (ชุดเก่ายังอยู่ ย้อนได้)
 *
...
export default function CartFloat() {
  ...
  return (
    ...
    >
      <img
        className="fabx-art fabx-cart-art"
        src="/landing/cart-shop-badge-v4.webp"
        alt=""
        width={1145}
        height={366}
        aria-hidden="true"
