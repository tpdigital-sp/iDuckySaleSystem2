 ...
 * ทั้งปุ่มตอนนี้คือรูปเดียว /landing/cart-shop-badge-v3.webp
 *
 * 22 ก.ย. 69 รอบ 2 — เจ้าของร้านส่ง "ภาพกองปุ่มชุดใหม่" มาทั้งแผ่น (4 ใบในภาพเดียว)
 * สั่งว่า "นำภาพที่ 1 ไปใส่แทนที่ภาพที่ 2" = เปลี่ยนทั้งกองพร้อมกัน ไม่ใช่ทีละใบ
 * ใบนี้ของใหม่มีบรรทัดรอง "เลือกของดี ๆ ใส่ตะกร้ากันเลย" + ลูกศรในวงกลม แคปซูลจึงหนาขึ้น
 * ทรงเปลี่ยน ระยะใน landing.css จึงวัดใหม่ทั้งชุด — ดู scripts/fab-badges-v3.mjs (ตัดภาพ+พิมพ์เลขให้)
 * ⚠️ ชื่อไฟล์ลงท้าย -v3 เพราะทับพาธเดิมแล้ว CDN/เบราว์เซอร์ยังจ่ายรูปเก่า (ชุด -v2 ยังอยู่ ย้อนได้)
 *
  ...
  return (
    ...
    >
      <img
        ...
        src="/landing/cart-shop-badge-v3.webp"
        alt=""
        width={1110}
        height={349}
        aria-hidden="true"
