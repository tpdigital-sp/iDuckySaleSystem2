...
export default function AdminEditFab({
  ...
  return (
    <Link
      ...
      className="group fixed bottom-5 right-5 z-40 max-[1000px]:bottom-[92px] max-[1000px]:left-4 max-[1000px]:right-auto inline-flex h-10 items-center gap-2 rounded-full bg-white/90 shadow-[0_2px_6px_rgba(15,23,42,0.12),0_10px_24px_rgba(15,23,42,0.18)] ring-1 ring-slate-900/10 backdrop-blur-md transition duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-[0_4px_10px_rgba(15,23,42,0.16),0_16px_32px_rgba(15,23,42,0.24)]"
    >
