...
export interface FolderMatch {
  ...
  sample?: {
    ...
    lines: string[];
    /**
     * ใบนี้ "ต้องแยกกล่องส่งตัวอย่างก่อน" จริงไหม = ยังมียอดค้าง (มัดจำ 50% / เก็บเงินไม่ครบ) เท่านั้น
     * ใบที่เก็บเงินครบแล้วตัวอย่างไปกล่องเดียวกับล็อตหลักได้ → หน้าจอติ๊กออกให้ก่อน ไม่ตั้งแผนให้เอง
     * (OD-260914-5746 · 16 ก.ย. 69 ตั้งแผน 3 ชิ้นให้ใบที่จ่ายครบ → ฝ่ายแพ็คถูกบังคับให้ยิงเป็น "ส่งบางส่วน" ทั้งที่ของไปครบกล่องเดียว)
     */
    needsRound: boolean;
  };
  /**
